...
X_worst = X_train[ind_100[:(len(X_train) // 10)]]
y_worst = y_train[ind_100[:(len(X_train) // 10)]]
...
def scoring_function(mod_name, hyperparams):
    ...
    append_to_pickle_file('../outputs/synthesizers/hyperparams_100_hard_10.pkl', hyperparams_log)
    append_to_pickle_file('../outputs/synthesizers/scores_100_hard_10.pkl', scores)
...
with open('../outputs/synthesizers/session_100_hard_10.pkl', "wb") as f:
